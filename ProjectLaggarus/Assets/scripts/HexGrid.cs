...
public class HexGrid : MonoBehaviour {
    ...
    void Start()
    {
        //TODO: Вынести все это в класс SaveLoadMenu хотя бы частично

        //создание карты при прогрузке сцены
        switch (MainMenu.NewMapFlag)
        {
            //small map
            case 1:
                CreateMap(20, 15, true);
                MainMenu.NewMapFlag = 0;
                break;
            //medium map
            case 2:
                CreateMap(40, 30, true);
                MainMenu.NewMapFlag = 0;
                break;
            //big map
            case 3:
                CreateMap(80, 60, true);
                MainMenu.NewMapFlag = 0;
                break;
        }
    }
